...
function FormatChip({ label, value }) {
  ...
  return (
    <button
      ...
      className="cb-glass-btn flex flex-col items-center gap-1 rounded-xl py-2 px-1 w-full active:scale-95 transition-all duration-150 cursor-pointer"
      style={{
        background: copied
          ? "linear-gradient(135deg, rgba(34,197,94,0.18), rgba(34,197,94,0.08))"
          : "linear-gradient(135deg, rgba(255,255,255,0.04), rgba(255,255,255,0.015))",
        border: "1px solid",
        borderColor: copied ? "rgba(34,197,94,0.32)" : "rgba(255,255,255,0.06)",
        boxShadow: copied
    ...
    >
      ...
      <span
        className="text-[8px] font-mono text-center leading-tight break-all"
        style={{ color: copied ? "#34D399" : "#A0A0AA" }}
      >
        {value}
      </span>
    </button>
...
export default function ColorBoard({
  ...
  // Smooth rAF-throttled board drag
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes cbSlideUp{from{opacity:0;transform:translateY(14px)}to{opacity:1;transform:translateY(0)}}
        .cb-enter{animation:cbSlideUp 0.28s cubic-bezier(0.22,1,0.36,1) both;}

        @keyframes cbGlassSweep{
          0%{transform:translateX(-150%) skewX(-25deg)}
          50%{transform:translateX(180%) skewX(-25deg)}
          100%{transform:translateX(180%) skewX(-25deg)}
        }
        .cb-sweep{position:relative;}
        .cb-sweep::after{
          content:"";position:absolute;top:0;left:0;width:35%;height:100%;
          background:linear-gradient(90deg,transparent,rgba(255,255,255,0.05),transparent);
          animation:cbGlassSweep 7s ease-in-out infinite;
      ...
      <div
        ref={boardRef}
        className="cb-enter cb-sweep z-50 select-none"
        style={{
          ...wrapStyle,
      ...
      >
        ...
        <div className="px-4 pt-3 pb-2" data-nodrag>
          ...
          >
            ...
            >
              <span style={{ color: target === "bg" ? "#60A5FA" : "#555" }}>
                <IconBg />
              </span>
              Background
              <div
            ...
            >
              <span style={{ color: target === "text" ? "#F472B6" : "#555" }}>
                <IconText />
              </span>
              Text
              <div
          ...
          {target === "text" && (
            <div className="mt-2 flex items-center justify-between gap-2 px-2">
              <div
                ...
                style={{ color: textIsAuto ? "#34D399" : "#666" }}
              >
                <IconSparkle />
        ...
        {/* ── Preview + Canvas ────────────────────────────────────────── */}
        <div
          className="flex mx-4 rounded-2xl overflow-hidden"
          style={{
            height: 188,
        ...
        {/* ── Hue slider ──────────────────────────────────────────────── */}
        <div className="px-4 pt-4 pb-2" data-nodrag>
          <div className="flex items-center gap-3">
            <span
        ...
        {/* ── Paste input ─────────────────────────────────────────────── */}
        <div className="px-4 pb-3" data-nodrag>
          <div
          ...
          >
            <span
              style={{
                color: inputError ? "#EF4444" : "#3A3A45",
                flexShrink: 0,
              }}
            >
        ...
        {/* ── Format chips ─────────────────────────────────────────────── */}
        <div className="px-4 pb-3 grid grid-cols-5 gap-1.5" data-nodrag>
        ...
        {/* ── Footer ──────────────────────────────────────────────────── */}
        <div
          className="px-4 pb-4 pt-2 flex items-center justify-between gap-3"
          style={{
        ...
        >
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="flex gap-1.5 flex-wrap">
              {history.length === 0 ? (
                <span className="text-[9px]" style={{ color: "#2E2E38" }}>
                  Pick a colour…
                </span>
              ) : (
                history.map((c, i) => (
