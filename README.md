...
🌐 **Live Demo:** [https://seeui.app](https://seeui.app)
...
1. **Build the project:**
   ...
   npm run build
   ```
   *(Note: The build script automatically copies the React Router output from `build/client` to `dist` for Appwrite compatibility).*
...
---
*Developed with ❤️ by [Somrat Chandra Roy](https://github.com/SomratChandraRoy).*
